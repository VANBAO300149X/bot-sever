...
# CANH CODE trước đây dùng Fore/Style nhưng bot-only không import colorama,
# khiến worker Telegram chết ngay khi hiển thị danh sách tài khoản.
# Dùng ANSI nội bộ để không phụ thuộc thêm package; Telegram sẽ tự loại ANSI.
class _AnsiFore:
    BLACK = "\033[30m"
    RED = "\033[31m"
    GREEN = "\033[32m"
