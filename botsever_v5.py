...
def _purchase_markup():
    # Nút chọn Key dùng INLINE KEYBOARD, không đưa vào Reply Keyboard.
    return {
        "inline_keyboard": [
            [{"text": _purchase_button_text("3d"), "callback_data": "buy:3d"},
             {"text": _purchase_button_text("1w"), "callback_data": "buy:1w"}],
            [{"text": _purchase_button_text("2w"), "callback_data": "buy:2w"},
             {"text": _purchase_button_text("1m"), "callback_data": "buy:1m"}],
            [{"text": _purchase_button_text("2m"), "callback_data": "buy:2m"}],
            [{"text": _purchase_button_text("forever"), "callback_data": "buy:forever"}],
            [{"text": "↩️ QUAY LẠI", "callback_data": "home"}],
        ]
    }
