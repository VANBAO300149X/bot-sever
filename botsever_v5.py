...
# Log vị trí lưu dữ liệu để dễ kiểm tra trên Render. Không in nội dung key.
print(f"📁 BOT DATA DIR: {BOT_DATA_DIR}", flush=True)
print(f"🔐 AUTH FILE: {BOT_AUTH_FILE}", flush=True)
