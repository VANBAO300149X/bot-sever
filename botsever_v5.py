...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8344831081:AAHazl6jJlsZ5Oev7VPLKrvJ6t2rFrpY-48").strip()
POLL_TIMEOUT = 25
MAX_TEXT = 3900
FLUSH_INTERVAL = 0.40
...
from cdtd_ai_module import analyze_cdtd_ai
...
def is_vip_activated() -> bool:
    ...
    try:
        if True:
            raw_auth = os.getenv("hồ sơ auth Telegram", "").strip()
            if raw_auth:
