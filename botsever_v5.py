...
def _purchase_markup():
    # Reply Keyboard theo kiểu "GIAN HÀNG CỦA ADMIN" trong ảnh mẫu.
    # Khi bấm 1 sản phẩm, handle_message() sẽ nhận đúng tên nút và tạo đơn như cũ.
    return {
        "keyboard": [
            [_purchase_button_text("3d"), _purchase_button_text("1w")],
            [_purchase_button_text("2w"), _purchase_button_text("1m")],
            [_purchase_button_text("2m")],
            [_purchase_button_text("forever")],
            ["↩️ QUAY LẠI"],
        ],
        "resize_keyboard": True,
        "is_persistent": True,
        "one_time_keyboard": False,
        "input_field_placeholder": "Chọn sản phẩm muốn mua...",
    }
...
def _purchase_text():
    return (
        ...
        "• 2 THÁNG — 50.000đ\n"
        "• VĨNH VIỄN — 150.000đ\n\n"
        "👉 Bấm sản phẩm bên dưới để tạo đơn."
    )
