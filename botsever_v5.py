    ...
    if upper_cmd.startswith("/DONHANG"):
        ...
        if not isinstance(order, dict):
            ...
            if not is_admin and str(order.get("telegram_id")) == str(chat_id) and status == "WAITING_PAYMENT":
                ...
                send_message(chat_id, _format_order(order), home_markup(chat_id))
        return
    ...
    if data == "home":
        ...
        if not ok:
            ...
            send_message(
                ...
                + _format_order(BOT_ORDERS.get(order_id, {})),
            )
        else:
            send_message(
                chat_id,
        ...
        if not isinstance(order, dict):
            ...
            send_message(chat_id, _format_order(order), markup)
